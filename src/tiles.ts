...
export const TileColor: Record<Tile, [Color | null, Color | null]> = {
  ...
  [Tile.Statue]: [Color.HighIntensityWhite | 16, null], // 31
  [Tile.K]: [Color.Yellow, null],
  [Tile.R]: [Color.Yellow, null],
  [Tile.O]: [Color.Yellow, null],
  [Tile.Z]: [Color.Yellow, null],
  [Tile.OWall1]: [Color.Brown, Color.Brown],
  [Tile.OWall2]: [Color.Brown, Color.Brown],
  [Tile.OWall3]: [Color.White, Color.White],
  ...
  [Tile.GBlock]: [Color.White, Color.Black],
  ...
  [Tile.Amulet]: [Color.HighIntensityWhite | 16, null], // 31
...
export const TileMessage: Record<number, string> = {
  ...
  [Tile.OSpell2]: 'Magic has been released is this chamber!',
  [Tile.OSpell3]: 'Magic has been released is this chamber!',
  [Tile.CSpell1]: 'New Walls have magically appeared!',
  [Tile.CSpell2]: 'New Walls have magically appeared!',
  [Tile.CSpell3]: 'New Walls have magically appeared!',
