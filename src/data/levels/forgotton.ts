...
const LEVELS = [
  ...
  async () => (await import('./kingdom/kingdom-4.map.json')).default, // Needs a teleport from previous level, Optional short left
  async () => (await import('./kingdom/kingdom-6.map.json')).default,

  // 10
  async () => (await import('./lost/lost-11.map.json')).default,
  async () => (await import('./kingdom/kingdom-12.map.json')).default, // Needs LavaFlow
  ...
  async () => (await import('./lost/lost-48.map.json')).default, // tabletMessage
